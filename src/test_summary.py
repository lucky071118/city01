...
class TestSummary(unittest.TestCase):
    ...
    def test_compute_score_2(self):
        ...
        # user3
        self.assertEqual(len(all_user_score['user3']), 5)
        self.assertEqual(all_user_score['user3']['a'], 196)
        self.assertEqual(all_user_score['user3']['b'], 199)
        self.assertEqual(all_user_score['user3']['c'], 195)
        self.assertEqual(all_user_score['user3']['d'], 192)
        self.assertEqual(all_user_score['user3']['e'], 198)
...
def test_create_output_rank_2(self):
        all_user_score = {}
        all_user_score['user1'] = {
            'a': 298,
            'b': 299,
